...
const Home = () => {
  ...
  const buttonVariants = {
    ...
    hover: {
      scale: 1.05,
      backgroundColor: "rgba(61, 145, 89, 1)",
  ...
  return (
    <div
  className="relative w-full min-h-screen flex flex-col justify-center items-center text-white px-4 sm:px-6 lg:px-8 
...
>
      ...
      >
        ...
        >
          Helping you secure the right loan with expert guidance, bank-ready
          documentation, and complete end-to-end support.
        </motion.p>
