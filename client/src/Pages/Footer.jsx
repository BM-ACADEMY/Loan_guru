...
export default function Footer() {
  ...
  <div className="flex items-center space-x-4 justify-start">
    <img
      src={Logo}
      alt="logo"
      className="w-20 object-contain" // removed mx-auto
    />
  </div>
  <p className="mt-6 text-sm">
    ...
    when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        ...
        <div className="flex-1 flex flex-col md:flex-row items-start md:justify-end gap-20">
          <div>
            <h2 className="font-semibold mb-5 text-gray-100">Usefull Links</h2>
          ...
          <div className="max-w-md"> {/* limit width of address section */}
            <h2 className="font-semibold mb-5 text-gray-100">Get in touch</h2>
            <div className="text-sm space-y-2">
              <p>+91 81109 76021</p>
              <p>contact@example.com</p>
              <p>
                LOKESH TOWER Old Door No.110/2, then Door No.18, Now New Door No.37,
                Kodambakkam High road, Nungambakkam, Chennai - 600 034, Tamilnadu, India
              </p>
            </div>
          </div>
        </div>
